...
import { BookmarkFill, Calendar3, PeopleFill, Plus, SquareHalf } from "react-bootstrap-icons";
      ...
      <Container className="leftSidebar ">
        <Row>
          <Col md="2">
            <Card className="leftSidebar mt-3">
              ...
              <Card.Body className="leftSidebarBody">
                <Card.Title className="text-center textProfile">
                  ...
                  <p className="leftSidebarSubtitle2">Capo d'Orlando, Sicily</p>
                  <button className="profile-card-add-experience-button text-body-xsmall"> <Plus/><span>Esperienza</span></button>
			...
			<Card  className="leftSidebar mt-3">
				<div className="p-2">
			<p className="leftSidebarSubtitle2 pt-2">Acquisisci nuove competenze con Premium</p>
			<SquareHalf fill="orange"/><span className="ps-2 text-black">Prova premium per 0 eur</span></div>
			</Card >
